<template>
  <div class="mainleft">
      ...
      <div class="cnt">
        ...
        <div class="btns">
            ...
            <i
              >({{
                playlistInfo.subscribedCount > 0
                  ? playlistInfo.subscribedCount > 10000
                    ? (playlistInfo.subscribedCount / 10000).toFixed(1) + '万'
          ...
          <a href="javascript:;" class="share">
            <i
              >({{
                playlistInfo.shareCount > 0
                  ? playlistInfo.shareCount > 10000
                    ? (playlistInfo.shareCount / 10000).toFixed(1) + '万'
          ...
          <a href="javascript:;" class="comment">
            <i
              >({{
                playlistInfo.commentCount > 0
                  ? playlistInfo.commentCount > 10000
                    ? (playlistInfo.commentCount / 10000).toFixed(1) + '万'
    ...
    <table class="list">
      ...
      <tbody>
        <tr
          v-for="(item, index) in playlistInfo.tracks"
          :key="item.id"
