    ...
    <div class="login-container" v-if="isShowLogin">
      <div class="login-box">
        <div class="topbar">
          ...
          <span v-else-if="phoneLoginOrRegister === 'register'"
            >手机号注册</span
          >
          <span v-else>登录</span>
        ...
        <div class="login-body">
          ...
          <div
            class="login-with-qr"
            v-if="loginMethod === 'QR' && phoneLoginOrRegister === ''"
          >
            <div class="qr-login">
          ...
          <div class="login-with-phone" v-else>
            ...
            <section class="pwd" v-if="loginwithPassword">
              ...
              <div class="warn" v-if="!checkPassword">
                <i></i>
                <span>手机号或密码错误</span>
              </div>
              <div class="btns">
  ...
  methods: {
    ...
    changeLoginMethod() {
      ...
      if (this.loginMethod === 'QR') {
        ...
        clearInterval(this.timer)
        if (this.countriesCodeList.length === 0) {
    ...
    loginWithPhone() {
      if (this.agree) {
        this.phoneLoginOrRegister = 'login'
        this.countryCode = '86'
      } else {
        this.$message({
    ...
    registerWithPhone() {
      if (this.agree) {
        this.phoneLoginOrRegister = 'register'
        this.countryCode = '86'
      } else {
        this.$message({
          message: '请先勾选同意《服务条款》《隐私政策》《儿童隐私政策》',
    ...
    loginCellphoneByCaptcha() {
      let result = this.$api.verifyCaptcha(
        this.phone,
        this.captcha,
        this.countryCode
      )
